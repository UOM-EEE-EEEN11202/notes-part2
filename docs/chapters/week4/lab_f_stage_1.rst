...
Licensing
^^^^^^^^^
Plotly logo is copied from `<https://commons.wikimedia.org/wiki/File:Plotly-logo.png>`_ and is licensed under `CC BY-SA 4.0 <https://creativecommons.org/licenses/by-sa/4.0/deed.en>`_.

Matplotlib logo is copied from `<https://commons.wikimedia.org/wiki/File:Created_with_Matplotlib-logo.svg>`_ and is unlicensed material.
